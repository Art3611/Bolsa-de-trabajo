...
<main class='flex flex-col'>
    ...
    <section class='bg-slider flex flex-col justify-center items-center'>
        <h1 class='text-center text-white text-3xl md:text-6xl p-5'>Encuentra tu mejor trabajo</h1>

        <article class='flex flex-col md:flex-row gap-14 mt-10'>
            <div class='bg-[#D9D9D9] bg-opacity-20 w-32 h-32 cursor-pointer rounded-full flex justify-center items-center p-5'>
    ...
    <section class='mt-10 p-10 md:p-20'>
        <h1 class='text-3xl md:text-5xl text-center'>Trabajos recomendados</h1>
