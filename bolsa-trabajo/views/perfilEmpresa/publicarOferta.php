...
<div class='bg-[#F3F6FB] md:w-[725px] p-10 rounded-lg'>
 ...
 <form action="<?= constant('URL')?>perfilEmpresa/registrarOferta" method="POST" class='flex flex-col gap-3 md:gap-5'>
    ...
    <input type="text" name='descripcion' class=' h-10 md:h-16 rounded-lg' maxlength="560" minlength="50" required>

    <label for="ubicacion">Ubicacion del empleo <span class='text-red-500'>*</span></label>
    <input type="text" name='ubicacion' class=' h-10 md:h-16 rounded-lg' minlength="50"  maxlength="255" required>

    <label for="contrato">Tipo de contrato <span class='text-red-500'>*</span></label>
    <input type="text" name='contrato' class=' h-10 md:h-16 rounded-lg' minlength="50"  maxlength="255" required>

    <label for="salario">Salario <span class='text-red-500'>*</span></label>
    <input type="text" name='salario' class=' h-10 md:h-16 rounded-lg' minlength="50"  maxlength="255" required>

    <label for="duracion">Duracion <span class='text-red-500'>*</span></label>
    <input type="text" name='duracion' class=' h-10 md:h-16 rounded-lg' minlength="50"  maxlength="255" required>

    <label for="requisitos">Requisitos <span class='text-red-500'>*</span></label>
    <textarea type="text" name='requisitos' class='h-10 md:h-16 rounded-lg resize-none'minlength="50"  maxlength="255" required></textarea>
